                                            ...
                                            <div class="col-lg-4 col-sm-7">
                                                <div class="d-flex flex-column align-items-center gap-3">
                                                    ...
                                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                        ...
                                                        <h6 class="nav-link text-center active" id="date-tab" data-toggle="tab" href="#date" role="tab" aria-controls="home" aria-selected="true" style="color: red;">Date</h6>             
                                                        
                                                        <h6 class="nav-link text-center" id="month-tab" data-toggle="tab" href="#month" role="tab" aria-controls="profile" aria-selected="false" style="color: red;">Month</h6>
                                                       
                                                        <h6 class="nav-link text-center" id="year-tab" data-toggle="tab" href="#year" role="tab" aria-controls="profile" aria-selected="false" style="color: red;">Year</h6>
