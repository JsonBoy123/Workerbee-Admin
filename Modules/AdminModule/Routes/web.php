...
use Modules\AdminModule\Http\Controllers\Api\V1\Admin\AddressController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin','mpc:employee_management']], function () {
    ...
    Route::get('address_show/{id}', [AddressController::class, 'view']);
    Route::get('address_edit/{id}', [AddressController::class, 'update']);
    Route::put('address_data_edit/{id}', [AddressController::class, 'edit']);
    Route::get('address_delete/{id}', [AddressController::class, 'destroy']);
